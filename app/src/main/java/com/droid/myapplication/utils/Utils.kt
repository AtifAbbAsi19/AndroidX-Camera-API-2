package com.droid.myapplication.utils
...
class Utils {
    ...
    fun getFromSdcard() {
        val file = File(android.os.Environment.getExternalStorageDirectory(), "TMyFolder")
    ...
    fun readFilesFormMemory() {
        ...
        val folder = File(Environment.getExternalStorageDirectory().toString() + "/Folder Name/")
        folder.mkdirs()
